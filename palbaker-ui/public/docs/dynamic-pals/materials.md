# Material Overrides & Reskins (Format V2)

Material overrides allow you to swap the textures and shaders of specific slots on your Pal's mesh dynamically per variant using Format V2 `SpecialMaterial` mappings. This enables lightweight reskins (such as shiny variants, element swaps, or accessory color shifts).

## How to Set Overrides

1. Click on your Dynamic Pal Variant Chip to open the Configurator modal.
2. Scroll down to Section 3: **Special Material Overrides**.
...
4. Hit **SYNC** inside your Dynamic Pals panel. PalBaker will headlessly read your Blender file, update your companion sidecars, and make your new material instantly selectable inside your overrides dropdown!