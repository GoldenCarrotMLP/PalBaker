...
export function PluginInstallModal({ isOpen, onClose, onConfirm }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="bg-card border-2 border-primary/30 rounded-xl max-w-md w-full shadow-2xl p-6 relative flex flex-col items-center text-center gap-4">
        ...
        <h3 className="text-foreground font-extrabold text-lg uppercase tracking-wider">
          Missing Unreal Helper Plugin!
        </h3>
        
        <p className="text-muted-foreground text-sm leading-relaxed">
          The PalBaker C++ editor helper plugin is not installed in your Unreal ModKit. I need this helper so I can cook, pack, and export standalone assets! ;3
        </p>
